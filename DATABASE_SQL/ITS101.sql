...
CREATE TABLE IF NOT EXISTS `ITS_KENNEDY`.`STATO` (
  ...
  `ritiro` TINYINT NULL DEFAULT NULL,
  `consegna` TINYINT NULL DEFAULT NULL,
  `guasto` TINYINT NULL DEFAULT NULL,
  `riparazione` TINYINT NULL DEFAULT NULL,
  `KO` TINYINT NULL DEFAULT NULL,
  PRIMARY KEY (`idSTATO`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `ITS_KENNEDY`.`CORSO` (
  ...
  `CORSO` VARCHAR(150) NULL DEFAULT NULL,
  `SEDE_idSEDE` INT NOT NULL,
  PRIMARY KEY (`idCORSO`),
